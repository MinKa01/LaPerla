...
public class EditProfileClienteFragment extends Fragment {

    private DatabaseHelper dbHelper;
    private OnNombreActualizadoListener onNombreActualizadoListener;

    public EditProfileClienteFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_edit_profile_cliente, container, false);
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            onNombreActualizadoListener = (OnNombreActualizadoListener) context;
